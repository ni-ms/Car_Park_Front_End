...
<script>
   ...
   export default {
     ...
     methods: {
        ...
        updatedb(){
           axios.get('http://localhost:8080/slot').then(function (results){
              this.parkingspot = results;
           })
           if (this.carmodel != "" && this.starttime != "" && this.endtime != "" && this.data != "") {
            
         
              axios.post('http://localhost:8080/slot', {
                 Car_Model: this.carmodel,
                 Start_Time: String.toString(this.date) + String.toString(this.starttime),
                 End_Time: String.toString(this.date) + String.toString(this.endtime),
                 Parking_Space_Number: this.selectedspot,
           ...
           if (this.starttime != "" && this.endtime != "" && this.data != "") {
